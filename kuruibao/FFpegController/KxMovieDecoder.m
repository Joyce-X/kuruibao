...
static NSString * errorMessage (kxMovieError errorCode)
{
    switch (errorCode) {
        ...
        case kxMovieErrorOpenFile:
            return NSLocalizedStringFromTable(@"Unable to open file", @"local",nil);
            
        case kxMovieErrorStreamInfoNotFound:
            return NSLocalizedStringFromTable(@"Unable to find stream information", @"local",nil);
            
        case kxMovieErrorStreamNotFound:
            return NSLocalizedStringFromTable(@"Unable to find stream", @"local",nil);
            
        case kxMovieErrorCodecNotFound:
            return NSLocalizedStringFromTable(@"Unable to find codec", @"local",nil);
            
        case kxMovieErrorOpenCodec:
            return NSLocalizedStringFromTable(@"Unable to open codec", @"local",nil);
            
        case kxMovieErrorAllocateFrame:
            return NSLocalizedStringFromTable(@"Unable to allocate frame", @"local",nil);
            
        case kxMovieErroSetupScaler:
            return NSLocalizedStringFromTable(@"Unable to setup scaler", @"local",nil);
            
        case kxMovieErroReSampler:
            return NSLocalizedStringFromTable(@"Unable to setup resampler", @"local",nil);
            
        case kxMovieErroUnsupported:
            return NSLocalizedStringFromTable(@"The ability is not supported", @"local",nil);
    }
}
