...
//     NSString *tempFilePath = [NSHomeDirectory() stringByAppendingPathComponent:@"Library/Private Documents/Temp"];
...
//
    ...
    tempFilePath = [NSString stringWithFormat:@"%@/%@", tempFilePath, [filePath substringFromIndex:lastCharRange.location + 1]];
