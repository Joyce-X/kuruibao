...
@interface XMSlideViewController ()<UIGestureRecognizerDelegate>
{
...
@implementation XMSlideViewController
...
- (UIStatusBarStyle)preferredStatusBarStyle
{
   ...
   return  [self.mainVC preferredStatusBarStyle];
