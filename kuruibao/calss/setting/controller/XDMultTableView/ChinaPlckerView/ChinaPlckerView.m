...
- (void)initPickerView{
    ...
    // 初始化视图CGRectMake(0, FITHEIGHT(181), kScreenWidth, IT_KEYBOARD_HEIGHT);
    self.frame = CGRectMake(0, FITHEIGHT(181), kScreenWidth, 216);
...
//    self.addPickVview.frame = CGRectMake(0,  253 - 216, kScreenWidth, 216);
//    self.addPickVview.backgroundColor = [UIColor redColor];
...
//    [titleView addSubview:sureBtn];
    ...
    pickerView.frame = CGRectMake(0, 0, kScreenWidth, 216);
...
-(void)showChinaPickerView
{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        ...
        self.addPickVview.frame = CGRectMake(0, FITHEIGHT(181), kScreenWidth, IT_KEYBOARD_HEIGHT);
    } completion:^(BOOL finished) {
//        [UIView animateWithDuration:0.25f animations:^{
////            self.hideView.backgroundColor =[UIColor redColor]; //COLOR(45, 47, 56, 0.2f);
//        } completion:^(BOOL finished) {
//            
//        }];
    }];
