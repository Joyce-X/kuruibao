...
@interface XMDVRLocalFileLockVideoVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIActionSheetDelegate>
...
#define identifier @"localLockVideo_reuseIdentifier"

@implementation XMDVRLocalFileLockVideoVC
...
-(NSMutableDictionary *)dataDictionary
{
    ...
    if (!_dataDictionary)
    {
        ...
        //!< 过滤掉所有不是视频的文件
        NSArray * subPaths = [[NSFileManager defaultManager] subpathsAtPath:directoryPath_EVENT];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    XMDVR_LocalImage_collectionRuseView *reusableView = reusableView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:identifier forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.indexPath = indexPath;
     ...
     UIActionSheet *sheet = [[UIActionSheet alloc]initWithTitle:@"本地锁定视频选择" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"播放",@"删除",@"全部删除", nil];
...
- (void)playVideo
{
    //!< play local event video
    NSString *fileName = [self getFileNameAtIndexPath:self.indexPath];
    
    NSString *filePath = [directoryPath_EVENT stringByAppendingPathComponent:fileName];
...
- (void)deleteDidClick
{
    ...
    [[NSFileManager defaultManager] removeItemAtPath:[directoryPath_EVENT stringByAppendingPathComponent:fileName] error:nil];
...
- (void)deleteAllDidClick
{
    ...
    [[NSFileManager defaultManager] removeItemAtPath:directoryPath_EVENT error:nil];
