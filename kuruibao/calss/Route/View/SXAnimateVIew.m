...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.subScore5 != 0) {
        ...
        if (self.isGradient)
        {
            ...
            UIColor *startColor = XMColor(221, 163, 254);
            
            UIColor *endColor = XMColor(96, 82, 233);
            
            //绘制渐变
            [self drawRadialGradient:ctx path:path startColor:startColor.CGColor endColor:endColor.CGColor];
        }else
        {
            //-----------------------------------------画线段
